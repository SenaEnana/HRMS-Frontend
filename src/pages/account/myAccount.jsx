    ...
    <div className="container mt-5 ">
      ...
      <div className="row justify-content-center">
        <div className="col-md-6">
          ...
          <h6 className="mt-12 text-black text-left">Username: {username}</h6>
          <input
            type="file"
            accept="image/*"
          ...
          <div className="d-flex justify-content-center">
            ...
            <Link to="/changePassword">
              <button className="btn btn-outline-secondary btn-sm mt-3 ms-1">
                Change password
              </button>
            </Link>
            <Link to="/">
              <button
                className="btn btn-danger btn-sm mt-3 ms-1"
