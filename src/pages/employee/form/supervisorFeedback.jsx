...
const SupervisorFeedback = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://localhost:7100/api/EvaluationFactor")
            ...
            .catch(error => console.error('Error fetching evaluation factors:', error));
    }, []);
            ...
            <form onSubmit={handleSubmit}>
                ...
                {selectedEmployeeId && (
                    <>
                                            ...
                                            {[1, 2, 3, 4, 5].map(rating => (
                                                <label key={rating} className="rating-label">
                                                    <input
                                                        ...
                                                        onChange={() => handleRatingChange(factor.id, rating)}
                                                    />
                        ...
                        <button className="submit-button" type="submit">Submit Evaluation</button>
                    </>
                )}
            </form>
        </div>
