...
function JobDetail() {
  ...
  useEffect(() => {
    fetch(`https://localhost:52339/Promotion/${id}`)
  ...
  async function applyOperation(jobId) {
    try {
      ...
      let result = await fetch(
        `https://localhost:52339/Promotion/ApplyForJob/${jobId}?userId=${userId}`,
        {
          method: "POST",
          headers: {
...
//             <h5 className="card-title bg-secondary p-2 rounded text-light">Job Detail</h5>
//             <table className="table table-hover text-dark fs-6">
//               <div className="row">
//                 <div className="col-md-10">
//                   <div>
