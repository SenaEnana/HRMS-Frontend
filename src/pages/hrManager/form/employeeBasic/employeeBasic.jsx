...
function EmployeeBasic() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch("https://localhost:7140/Department/GetDepartments");
      const newData = await response.json();
      ...
      >
        {(formikValues) => (
          <form className="form-group rounded border col-10 ms-5 ms-4 bg-light">
            ...
            >
              <div className="flex text-dark"><span className="pr-16 ">Gender :  </span>
              ...
              <div className="flex mb-8 text-dark "><span className="pr-16">Marital Status :  </span>
            ...
            >
              ...
              {BranchId.map((branch, name) => (
                <DropDown
                  ...
                  onChange={(selectedOption) => {
                    formikValues.setFieldValue("BranchId", selectedOption.value); // Set the value, not the whole object
                  }}
                />
              ))}
